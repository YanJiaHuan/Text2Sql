...
task_name = 'title_train.json'
# authors_train.json, keywords_train.json, background_train.json, methodologies_train.json, conclusions_train.json
# Load your dataset
data = load_dataset('json', data_files=data_path+task_name)
...
training_args = TrainingArguments(
    ...
    save_strategy='steps',
    save_steps = 800,
    num_train_epochs=40,  # specify the number of epochs you want here
...
#
# model = GPT2LMHeadModel.from_pretrained("./AI_Tutor_Training/checkpoint-2400")
